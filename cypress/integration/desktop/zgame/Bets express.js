...
describe('Ставки', () => {
    ...
    it.skip('C459478 - добавление 2ух купонов по разным матчам - сделать ставку ', () => {
        auth.login();
        // делает ставку на главной странице
        bets.two_bets_in_different_match_express();
    });
    // данный кейс сложно реализовать на фронте
    it.skip('C459479  - экспресс ставка с дополнительным бонусом', () => {
        auth.login();
    });
    ...
    it.skip('C459481 - Невозможность выбора экспресс при наличии купонов по одному матчу', () => {
        auth.login();
